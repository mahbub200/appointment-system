...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['cus_add1'] = 'test@gmail.com';
        $post_data['cus_add2'] = 'test@gmail.com';
        $post_data['total_amount'] = '1000'; # You cant not pay less than 10
        $post_data['currency'] = "BDT";
        $post_data['tran_id'] = uniqid(); // tran_id must be unique
        # CUSTOMER INFORMATION
        $post_data['doctor_id'] = $request->doctorId;
        $post_data['appointmentId'] = $request->appointmentId;
        ...
        $update_product = DB::table('bookings')
            ...
            ->updateOrInsert([
                ...
                'date' => $post_data['date'],
                'status' => 0,
                'payment' => $post_data['total_amount'],
                'transaction_id' => $post_data['tran_id'],
            ]);

        $sslc = new SslCommerzNotification();
        Time::where('appointment_id', $request->appointmentId)->where('time', $post_data['time'])->update(['status' => 1]);
    ...
    public function success(Request $request)
    {
        ...
        $order_detials = DB::table('bookings')
            ...
            ->select('transaction_id', 'status', 'payment')->first();
